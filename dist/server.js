...
eval("module.exports = require('matter-js');\n\n//////////////////\n// WEBPACK FOOTER\n// external \"require('matter-js')\"\n// module id = 8\n// module chunks = 0\n\n//# sourceURL=webpack:///external_%22require('matter-js')%22?");
...
"use strict";
eval("/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__(7);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_polyfill__);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_matter_js__ = __webpack_require__(8);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_matter_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_matter_js__);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_socket_io__ = __webpack_require__(9);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_socket_io___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_socket_io__);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__db__ = __webpack_require__(5);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__events__ = __webpack_require__(6);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config__ = __webpack_require__(0);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__logger__ = __webpack_require__(1);\nvar _this = this;\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\n\n\n\n\n\n\n\n\nvar io = __WEBPACK_IMPORTED_MODULE_2_socket_io___default()(9000);\nvar NAMES = ['Pierre', 'Charles', 'Yvonne', 'Jules', 'Maxime', 'Florent', 'Angéline', 'Julie'];\nvar rand = function rand(min, max) {\n  return Math.floor(Math.random() * max + min);\n};\n\nvar run = function run() {\n  io.on(__WEBPACK_IMPORTED_MODULE_4__events__[\"a\" /* CONNECTION */], function () {\n    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(socket) {\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              __WEBPACK_IMPORTED_MODULE_3__db__[\"a\" /* player */].insert({\n                name: NAMES[rand(0, NAMES.length - 1)],\n                x: rand(0, __WEBPACK_IMPORTED_MODULE_5__config__[\"b\" /* WIDTH */]),\n                y: rand(0, __WEBPACK_IMPORTED_MODULE_5__config__[\"c\" /* HEIGHT */])\n              });\n\n              // Connect events\n              _context.t0 = socket;\n              _context.t1 = __WEBPACK_IMPORTED_MODULE_4__events__[\"b\" /* SET_PLAYERS */];\n              _context.next = 5;\n              return __WEBPACK_IMPORTED_MODULE_3__db__[\"a\" /* player */].getAll();\n\n            case 5:\n              _context.t2 = _context.sent;\n\n              _context.t0.emit.call(_context.t0, _context.t1, _context.t2);\n\n              __WEBPACK_IMPORTED_MODULE_3__db__[\"a\" /* player */].onChange(function (p) {\n                return io.emit(__WEBPACK_IMPORTED_MODULE_4__events__[\"c\" /* UPDATE_PLAYER */], p);\n              });\n              socket.on(__WEBPACK_IMPORTED_MODULE_4__events__[\"c\" /* UPDATE_PLAYER */], __WEBPACK_IMPORTED_MODULE_3__db__[\"a\" /* player */].update); // Should be checked (for cheating player)\n\n            case 9:\n            case 'end':\n              return _context.stop();\n          }\n        }\n      }, _callee, _this);\n    }));\n\n    return function (_x) {\n      return _ref.apply(this, arguments);\n    };\n  }());\n};\n\nrun();\n\n// Test physic engine on server-side\nvar engine = __WEBPACK_IMPORTED_MODULE_1_matter_js___default.a.Engine.create();\nvar boxA = __WEBPACK_IMPORTED_MODULE_1_matter_js___default.a.Bodies.rectangle(400, 200, 80, 80);\nvar boxB = __WEBPACK_IMPORTED_MODULE_1_matter_js___default.a.Bodies.rectangle(450, 50, 80, 80);\nvar ground = __WEBPACK_IMPORTED_MODULE_1_matter_js___default.a.Bodies.rectangle(400, 610, 810, 60, { isStatic: true });\n\n__WEBPACK_IMPORTED_MODULE_1_matter_js___default.a.World.add(engine.world, [boxA, boxB, ground]);\n\n__WEBPACK_IMPORTED_MODULE_6__logger__[\"a\" /* default */].debug('boxA', boxA.position);\n__WEBPACK_IMPORTED_MODULE_6__logger__[\"a\" /* default */].debug('boxB', boxB.position);\n\n// loop\nfor (var i = 0; i < 100; i += 1) {\n  __WEBPACK_IMPORTED_MODULE_1_matter_js___default.a.Engine.update(engine, engine.timing.delta);\n}\n\n__WEBPACK_IMPORTED_MODULE_6__logger__[\"a\" /* default */].debug('boxA', boxA.position);\n__WEBPACK_IMPORTED_MODULE_6__logger__[\"a\" /* default */].debug('boxB', boxB.position);\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/server.js\n// module id = 16\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/server.js?");
